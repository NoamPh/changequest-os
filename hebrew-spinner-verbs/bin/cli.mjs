#!/usr/bin/env node
// hebrew-spinner-verbs — funny Hebrew verbs for Claude Code's thinking spinner.
...
function printHelp() {
  console.log(`hebrew-spinner-verbs — funny Hebrew verbs for Claude Code's thinking spinner

Usage:
  npx hebrew-spinner-verbs [options]
...
Docs: https://github.com/NoamPh/hebrew-spinner-verbs`);
}
